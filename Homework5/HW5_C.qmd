...
#table(coaster_data$Type, useNA = "always")
#No missing values
#coaster_data |>
  group_by(Type) |>
  drop_na(Type) |>
...
**Interpretation:** There are no Family, Kiddie, or Thrill coasters of any type (wood or steel) which invert the riders. Only Extreme coasters invert riders.
